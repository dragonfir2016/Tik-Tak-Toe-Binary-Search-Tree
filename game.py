...
You will be shown a current board state and after that you will have to \
enter the postion
where you want ot make move.

    Your next move should be entered in this format: 0 2 , where 0 is a \
ROW and 2 is a COLUMN.
